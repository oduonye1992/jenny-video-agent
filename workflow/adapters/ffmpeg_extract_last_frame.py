"""FFmpeg extract_last_frame adapter — extract the last frame from a video."""
...
@register("ffmpeg_extract_last_frame")
class FfmpegExtractLastFrameAdapter(FfmpegBase):
    """Extract the last frame from a video as a PNG."""
